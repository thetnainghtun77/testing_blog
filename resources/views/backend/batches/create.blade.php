	        ...
	        <div class="card-body">
	            ...
	            <form action="{{ route('batches.store') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="text" class="form-control" id="batchTitle" placeholder="Enter Batch Title" name="title">
				    	</div>
					</div>
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="date" class="form-control" id="enctype" name="enddate">
				    	</div>
					</div>
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="text" class="form-control" id="courseDuring" placeholder="Enter  Time" name="time">
				    	</div>
					</div>
